...
class FormInputTextEditor extends BaseComponent {
    ...
    formatDoc = (sCmd, sValue) => {
        ...
        if (!oDoc) return;
        if (this.validateMode()) { document.execCommand(sCmd, false, sValue); oDoc.focus(); }
    }
        ...
        return (
            <div>
                ...
                <div id="toolBar2">
                    ...
                    <a className="palete">Remove Formatting</a>
                    ...
                    <a className="palete">Underline</a>
                    ...
                    <a className="palete">Left Align</a>
                    ...
                    <a className="palete">Center Align</a>
                    ...
                    <a className="palete">Right Align</a>
                    ...
                    <a className="palete">Numbered List</a>
                    ...
                    <a className="palete">Dotted List</a>
                    ...
                    <a className="palete">Add orientation</a>
                    ...
                    <a className="palete">Delete Indentation</a>
                ...
                <p id="editMode"><input type="checkbox" onChange={this.setEditMode} checked={this.state.editMode} name="switchMode" id="switchBox"
