        ...
        return (
            <div>
                ...
                <div id="toolBar2">
                    ...
                    <a  onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="undo" className="palete">Undo</a>
                    ...
                    <a  onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="redo"  className="palete">Redo</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="removeFormat" className="palete">Remove Formatting</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="bold" className="palete">Bold</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="italic" className="palete">Italic</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="underline" className="palete">Underline</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="justifyleft" className="palete">Left Align</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="justifycenter" className="palete">Center Align</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="justiryright" className="palete">Right Align</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="insertorderedlist" className="palete">Numbered List</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="insertonorderedlist" className="palete">Dotted List</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="formatblock" data-value="blockquote" className="palete">Quote</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="outdent" className="palete">Add orientation</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="indent" className="palete">Delete Indentation</a>
                    ...
                    <a className="palete">Hyperlink</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="cut" className="palete">Cut</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="copy" className="palete">Copy</a>
                    ...
                    <a onMouseDown={(e)=>e.preventDefault()}  onClick={this.paleteCommand} data-command="paste" className="palete">Paste</a>
                ...
                <div ref={this.contentRef} id="textBox" contentEditable="true"><p>Lorem ipsum</p></div>
